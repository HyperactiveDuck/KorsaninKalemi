    ...
    <footer className="bg-bordeaux text-gray-500 py-16 border-t border-gray-900">
      <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <nav className="flex gap-8 text-xs font-bold uppercase tracking-widest text-white">
          ...
          <a href="#philosophy" onClick={(e) => onNavigate(e, 'philosophy')} className="hover:text-crimson transition-colors">Ben Kimim</a>
          <a href="#approach" onClick={(e) => onNavigate(e, 'approach')} className="hover:text-crimson transition-colors">Kitaplarım</a>
          <a href="#services" onClick={(e) => onNavigate(e, 'services')} className="hover:text-crimson transition-colors">Etkinlikler</a>
          <a href="#library" onClick={(e) => onNavigate(e, 'library')} className="hover:text-crimson transition-colors">Kütüphane</a>
